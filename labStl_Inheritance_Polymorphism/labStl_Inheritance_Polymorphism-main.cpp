...
const string DEFAULT_INPUT_FILENAME  = "labStl_Inheritance_Polymorphism-inputA.tab";
const string DEFAULT_OUTPUT_FILENAME = "labStl_Inheritance_Polymorphism-outputA.txt";
